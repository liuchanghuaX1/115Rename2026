...
// @version         1.4.0
// @description     115网盘视频整理：保留本地标题加工与网络改名分离。修复本地加工丢失日期的问题。支持T28/单字母番号(h637)、防误伤透视引擎(修复DASS截断)、part1转-1分段、彻底免疫空格日期干扰。已知问题：暂不支持JavDB刮削与FC2网站改名。
// @author          sonarlee
...
(function () {
    ...
    // 【本地改名专用】强制使用提取到的 vInfo.date，即使 UI 未勾选也会保留已有时间
